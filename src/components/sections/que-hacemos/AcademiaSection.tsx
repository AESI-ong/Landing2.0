      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 lg:mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            Academia "Empoderamiento Económico"
          </h2>
          <div className="w-32 lg:w-48 h-1.5 bg-gradient-to-r from-rojo-aesi to-rojo-aesi/50 mx-auto rounded-2xl"></div>
        </div>
            ...
            >
              <div className="relative bg-gradient-to-b from-gray-600 via-gray-400 to-gray-200 h-48 lg:h-52 flex flex-col">
                <div className="flex justify-between items-start p-4 relative z-10">
                  ...
                  <span className="bg-rojo-aesi text-white px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1">
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <button className="bg-rojo-aesi hover:bg-red-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 w-full hover:scale-[1.02] active:scale-[0.98]">
                  Ver Detalles
                  <ArrowRight size={16} />
                </button>
              </div>
